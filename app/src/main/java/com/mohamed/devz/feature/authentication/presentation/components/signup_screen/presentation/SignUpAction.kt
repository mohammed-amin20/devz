...
sealed interface SignUpAction {
    ...
    data class IsCompanyToggled(val isCompany: Boolean) : SignUpAction
    data class CompanyNameChanged(val value: String) : SignUpAction
    data class RegisterClicked(
        val onSuccess: () -> Unit,
        val onCompanySuccess: () -> Unit = onSuccess,
    ) : SignUpAction
}
